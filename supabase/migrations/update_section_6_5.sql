...
exercise_schema = '{
  "exercise_id": "6.5-optimization-performance",
  "title": "Optimize an Automation",
  "objectives": [
    "Measure baseline automation performance",
    "Identify bottlenecks using I-T-O analysis",
    "Apply optimization strategies",
    "Right-size AI using capability tiers",
  ...
  "parts": [
    {
      ...
      "type": "measurement",
      "task": "Measure current execution time, cost, and throughput",
      "metrics": ["execution_time", "cost_per_run", "throughput"],
      "connection_to_module_2": "I-T-O analysis of each step"
    },
    {
      "part_number": 2,
      "title": "Identify Optimization Opportunities",
      "type": "analysis",
      "task": "Analyze each step for improvement potential",
      "techniques": ["parallel", "batch", "cache", "filter", "right_size"],
    ...
    },
    {
      ...
      "type": "implementation",
      "task": "Apply at least 3 optimization techniques",
      "minimum_optimizations": 3,
    ...
    },
    {
      ...
      "type": "measurement",
      "task": "Re-measure and compare to baseline",
    ...
    },
    {
      ...
      "type": "analysis",
      "task": "Calculate ROI for each optimization",
      "elements": ["implementation_time", "monthly_savings", "payback_period"]
    },
    {
      "part_number": 6,
      "title": "AI Optimization",
      "type": "advanced",
      "task": "Apply capability tier right-sizing",
      "connection_to_module_3": "Capability tiers",
      "scope": "advanced"
    },
    {
      "part_number": 7,
      "title": "Create Optimization Playbook",
      "type": "documentation",
      "task": "Document reusable optimization strategies",
      "scope": "advanced"
    }
  ],
  "deliverable": {
    "format": "measurement_documentation",
    "minimum_optimizations": 3,
  ...
  "connections": {
    "module_2": "I-T-O framework for step analysis",
    "module_3": "Capability tiers for AI right-sizing",
    "section_6_1": "Lead intake automation as test subject",
    "section_6_3": "Error handling preserved during optimization",
    "section_6_4": "Testing to verify no regression"
  }
}'

...
exercise_schema = '{
  "exercise_id": "4.4-specialized-tools-content",
  "title": "Create Multi-Modal Content",
  "objectives": [
    "Use specialized AI tools for image and audio generation",
    "Apply I-T-O framework to non-text content creation",
    "Experience iteration process for quality improvement",
    "Compare AI-generated content to alternatives"
  ],
  "parts": [
    {
      ...
      "deliverables": ["hero_image", "problem_state", "solution_state", "collaboration", "success"],
      "documentation_per_image": ["initial_prompt", "quality_rating", "issues", "revised_prompt", "iterations", "final_assessment", "usability"],
      "connection_to_module_2": "I-T-O framework for visual content"
    },
    {
      "part_number": 2,
      "title": "Voice Content Creation",
      "type": "audio_creation",
      "tool": "ElevenLabs",
      "steps": ["script_writing", "voice_generation", "evaluation", "iteration"],
      "deliverables": ["script_text", "audio_file"],
      "documentation_required": ["voice_selection", "quality_assessment", "iterations", "time_tracking"]
    },
    {
      "part_number": 3,
      "title": "Content Pipeline Integration",
      "type": "multi_tool_workflow",
      "topic": "3 signs your business process needs automation",
      "deliverables": ["article_outline", "featured_image", "quote_graphic", "audio_version"],
      "time_tracking_required": true,
      "comparison_to_traditional": true
    },
    {
      "part_number": 4,
      "title": "Rapid Prototyping Scenario",
      "type": "prototype_creation",
      "purpose": "Client feedback before full production",
      "deliverables": ["sample_script", "sample_visual", "sample_voiceover", "storyboard"],
      "documentation_required": ["total_time", "feedback_needs", "prototype_vs_production_differences"]
    },
    {
      "part_number": 5,
      ...
      "comparisons": {
        "image": ["ai_generated", "stock_photo", "professional_design"],
        "audio": ["ai_generated", "self_recorded", "professional_voiceover"]
      },
      "comparison_criteria": ["relevance", "uniqueness", "quality", "cost", "time"],
    ...
    },
    {
      ...
      "required_calculations": ["monthly_needs_inventory", "tool_costs", "alternative_costs", "roi_assessment", "break_even_point"]
    },
    {
      "part_number": 7,
      "title": "Workflow Design",
      "type": "process_design",
      "workflows_to_design": ["presentation_creation", "training_content", "social_media_content"],
      "required_elements": ["tool_sequence", "time_estimates", "automation_opportunities"]
    }
  ],
  "deliverable": {
    "format": "folder",
    "contents": {
      "content_files": ["presentation_images", "audio_narration", "pipeline_outputs", "prototype_materials"],
      "documentation": ["prompts_with_iterations", "quality_assessments", "time_tracking", "comparison_analysis", "budget_analysis", "workflow_design"],
      "reflection": ["best_value_tools", "challenges", "limitations", "lessons_learned", "recommendations"]
    }
  },
  "success_criteria": [
    "Created content with 2+ specialized tools",
    "Applied I-T-O framework to non-text prompts",
    "Iterated to improve initial results",
    "Assessed quality honestly",
    "Completed cost and time comparisons",
    "Designed practical workflow"
  ],
  "estimated_time_minutes": 120,
  "connections": {
    "module_2": "I-T-O framework, execution layer",
    "module_3": "Iterative refinement principles"
  }
}'

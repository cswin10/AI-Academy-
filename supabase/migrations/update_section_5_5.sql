...
exercise_schema = '{
  "exercise_id": "5.5-privacy-security",
  "title": "Privacy and Security Audit",
  "objectives": [
    "Document a system including all data and flows",
    "Assess legal basis for data processing",
    "Evaluate consent mechanisms",
    "Audit security controls",
    "Assess vendor relationships",
    "Evaluate data subject rights fulfillment",
  ...
  "parts": [
    {
      "part_number": 1,
      "title": "System Selection and Documentation",
      "type": "documentation",
      "task": "Document system and all data",
      "elements": ["purpose", "users", "data_collected", "pii_identification", "storage", "data_flows"]
    },
    {
      "part_number": 2,
      "title": "Legal Basis Assessment",
      "type": "assessment",
      "task": "Assess legal basis for each data category",
      "basis_types": ["consent", "contract", "legal_obligation", "legitimate_interest"],
      "assessment_per_category": true
    },
    {
      "part_number": 3,
      "title": "Consent Audit",
      "type": "audit",
      "task": "Evaluate consent collection and management",
      "criteria": ["freely_given", "specific", "informed", "unambiguous", "documented", "withdrawable"],
    ...
    },
    {
      ...
      "type": "audit",
      "task": "Evaluate privacy policy completeness",
      "checklist": ["what_collected", "why_collected", "how_used", "who_shared", "retention", "rights", "contact", "exercise_rights"],
      "rating_required": true
    },
    {
      "part_number": 5,
      ...
      "type": "audit",
      "task": "Evaluate security controls",
      "categories": ["access_control", "data_protection", "account_security", "application_security", "monitoring"],
      "rating_per_category": true
    },
    {
      "part_number": 6,
      "title": "Vendor Audit",
      "type": "audit",
      "task": "Inventory and assess all vendors",
      "elements": ["name", "purpose", "data_received", "storage_location", "certifications", "dpa_status", "risk_level"]
    },
    {
      "part_number": 7,
      "title": "Data Subject Rights Audit",
      "type": "audit",
      "task": "Assess rights fulfillment capability",
      "rights": ["access", "rectification", "erasure", "portability"],
      "rating_per_right": true
    },
    {
      "part_number": 8,
      "title": "Retention Policy Audit",
      "type": "design",
      "task": "Evaluate and design retention schedule",
      "elements": ["policy_exists", "periods_defined", "automation", "backup_inclusion"],
    ...
    },
    {
      ...
      "type": "design",
      "task": "Create breach response plan",
      "stages": ["detection", "containment", "assessment", "notification", "communication", "remediation", "documentation"]
    },
    {
      "part_number": 10,
      "title": "Create Action Plan",
      "type": "synthesis",
      "task": "Compile prioritized action plan",
      "priority_levels": ["critical", "high", "medium", "ongoing"],
      "elements": ["issue", "action", "owner"]
    },
    {
      "part_number": 11,
      "title": "Create Standards Document",
      "type": "documentation",
      "task": "Write comprehensive standards",
      "sections": ["purpose", "classification", "collection", "access", "security", "vendors", "retention", "rights", "incidents", "monitoring"]
    }
  ],
  "deliverable": {
    "format": "audit_package",
    "contents": ["system_documentation", "legal_basis_assessment", "consent_audit", "privacy_policy_audit", "security_audit", "vendor_audit", "rights_audit", "retention_policy", "breach_response_plan", "action_plan", "standards_document"]
  },
  "success_criteria": [
    ...
    "Rights processes evaluated",
    "Retention policy complete",
    "Breach response plan comprehensive",
    "Action plan prioritized and actionable",
    "Standards document organizationally usable"
  ],
  "estimated_time_minutes": 120,
  "connections": {
    "module_2": "4-layer model privacy considerations",
    "section_5_1": "Data flow privacy mapping",
    "section_5_3": "Schema privacy by design",
    "section_5_4": "Data quality for compliance"
  }
}'

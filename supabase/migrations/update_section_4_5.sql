...
exercise_schema = '{
  "exercise_id": "4.5-tool-stack-design",
  "title": "Build Your Personal Tool Stack",
  "objectives": [
    "Apply tool selection framework systematically",
    "Connect tool choices to 4-layer model and I-T-O framework",
    "Make evidence-based decisions through testing",
    "Calculate and justify ROI for toolkit investments"
  ],
  "parts": [
    {
      "part_number": 1,
      ...
      "type": "inventory",
      "required_data": ["tool_name", "category", "monthly_cost", "last_used", "use_case", "satisfaction"],
      "analysis_outputs": ["total_cost", "usage_frequency", "elimination_candidates"]
    },
    {
      "part_number": 2,
      ...
      "task_analysis": {
        "count": 5,
        "per_task": ["description", "frequency", "current_tool", "ito_summary", "satisfaction"]
      },
      "gap_analysis": ["struggles", "time_issues", "quality_issues", "automation_opportunities"],
      "must_haves": ["budget", "integrations", "compliance", "technical"]
    },
    {
      "part_number": 3,
      ...
      "per_layer": ["current_tools", "gaps", "ideal_state"],
      "output": "biggest_layer_gap",
      "connection_to_module_2": "4-layer automation model"
    },
    {
      "part_number": 4,
      "title": "Evaluate Key Decisions",
      "type": "decision_analysis",
      "categories_to_evaluate": 3,
      "scoring_dimensions": ["fit", "ease", "cost", "integration", "reliability"],
      "per_category_output": "weighted_decision_with_justification"
    },
    {
      "part_number": 5,
      ...
      "type": "validation",
      "tests_required": 3,
      "per_test": ["real_task", "measured_outcomes", "comparison_if_possible", "decision_confirmation"]
    },
    {
      "part_number": 6,
      "title": "Design Stack",
      "type": "synthesis",
      "tiers": {
        "tier_1_core": {"frequency": "daily", "items": 3},
        "tier_2_regular": {"frequency": "weekly", "items": 2},
        "tier_3_occasional": {"frequency": "as_needed", "items": "variable"}
      },
      "per_tool": ["name", "purpose", "cost", "justification"],
      "changes": ["additions", "cancellations", "upgrades", "downgrades"]
    },
    {
      "part_number": 7,
      "title": "Calculate ROI",
      "type": "financial_analysis",
      "required_inputs": ["hourly_value", "time_saved_tier_1", "time_saved_tier_2", "total_cost"],
      "outputs": ["value_created", "roi_ratio", "investment_assessment"]
    },
    {
      "part_number": 8,
      ...
      "timeline": "4_weeks",
      "required_elements": ["week_1_actions", "learning_priorities", "integration_work", "review_plan"]
    }
  ],
  "deliverable": {
    "format": "document",
  ...
  "success_criteria": [
    ...
    "Evaluated 3+ decisions with scoring framework",
    "Tested decisions with real tasks",
    "Created justified, organized tool stack",
    "Calculated positive ROI",
    "Have concrete implementation plan",
    "Can explain choices to others"
  ],
  "estimated_time_minutes": 90,
  "connections": {
    "module_1": "Capability tier matching",
    "module_2": "4-layer automation model, I-T-O framework",
    "module_3": "Task design principles",
    "module_4_sections": "Integration of all Section 4.1-4.4 tools"
  }
}'

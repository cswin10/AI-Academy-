...
exercise_schema = '{
  "exercise_id": "5.2-storage-tool-selection",
  "title": "Storage Tool Selection and Design",
  "objectives": [
    "Select appropriate storage tools for different scenarios",
    "Design implementations in multiple tools to understand tradeoffs",
    "Plan realistic data migrations",
    "Design hybrid architectures for complex needs",
    "Connect storage choice to automation capabilities"
  ],
  "parts": [
    {
      "part_number": 1,
      "title": "Scenario Analysis and Tool Selection",
      "type": "analysis",
      "task": "Recommend and justify storage tool for each scenario",
      "scenarios": ["freelance_project_tracker", "startup_customer_database", "content_marketing_calendar", "ecommerce_inventory", "meeting_notes_archive"],
      "required_elements": ["recommendation", "justification", "change_conditions"]
    },
    {
      "part_number": 2,
      "title": "Comparative Design",
      "type": "design",
      "task": "Design same system in two different tools",
      "tools_to_compare": ["google_sheets", "airtable"],
      "scenario": "startup_customer_database",
      "design_elements": ["tables_or_sheets", "fields_or_columns", "relationships", "views", "limitations"]
    },
    {
      "part_number": 3,
      "title": "Migration Planning",
      "type": "planning",
      "task": "Plan migration from spreadsheet to better solution",
      "steps": ["assessment", "destination_selection", "schema_design", "migration_process", "post_migration"],
      "scenario": "marketing_agency_leads"
    },
    {
      "part_number": 4,
      "title": "Hybrid Architecture Design",
      "type": "architecture",
      "task": "Design multi-tool architecture",
      "components": ["structured_data", "documents_files", "knowledge_base", "automation"],
      "required_elements": ["tool_selection", "integration_design", "source_of_truth", "data_flow"]
    },
    {
      "part_number": 5,
      "title": "Future-Proofing Analysis",
      "type": "analysis",
      "task": "Identify growth scenarios requiring tool changes",
      "scenarios": "all_from_part_1",
      "analysis_elements": ["growth_trigger", "next_tool", "migration_complexity"]
    },
    {
      "part_number": 6,
      "title": "Connection to Automation",
      "type": "design",
      "task": "Design automations showing why storage choice matters",
      "automation_count": 3,
      "required_elements": ["trigger", "logic", "action", "storage_implications"],
      "connection_to_module_2": "4-layer model execution layer"
    }
  ],
  "deliverable": {
    "format": "document",
    "contents": ["scenario_analyses", "comparative_designs", "migration_plan", "hybrid_architecture", "future_proofing", "automation_designs"]
  },
  "success_criteria": [
    "Tool recommendations match requirements with justification",
    "Comparative designs reveal tool differences",
    "Migration plan is actionable",
    "Hybrid architecture avoids data silos",
    "Future-proofing identifies realistic growth",
    "Automations demonstrate storage-automation connection"
  ],
  "estimated_time_minutes": 75,
  "connections": {
    "module_2": "4-layer model execution layer",
    "section_5_1": "Data flow storage stage",

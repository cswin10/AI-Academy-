...
exercise_schema = '{
  "exercise_id": "4.3-nocode-ai-workflows",
  "title": "Build No-Code AI Workflows",
  "objectives": [
    "Build working AI-powered automations using no-code platforms",
    "Apply 4-layer model and I-T-O framework to visual workflow design",
    "Compare platform tradeoffs through hands-on experience",
    "Calculate cost thresholds for no-code versus code graduation"
  ],
  "parts": [
    {
      "part_number": 1,
      "title": "Intelligent Lead Classification",
      "type": "workflow_build",
      "platform": "Zapier",
      "ito_structure": {
        "input": "Form submission with name, email, company, message, budget",
        "task": "Classify as Hot, Warm, or Cold based on explicit criteria",
        "output": "Spreadsheet row plus conditional Slack notification"
      },
      "test_scenarios": 3,
      "documentation_required": ["screenshots", "prompt_text", "test_results", "cost_estimate"],
      "connection_to_module_3": "Classification pattern with explicit criteria"
    },
    {
      "part_number": 2,
      "title": "Data Extraction from Text",
      "type": "workflow_build",
      "platform": "Make",
      "ito_structure": {
        "input": "Unstructured email text",
        "task": "Extract structured appointment details",
        "output": "JSON object with specific fields"
      },
      "test_scenarios": 3,
      "documentation_required": ["scenario_config", "extraction_prompt", "json_outputs"],
      "connection_to_module_3": "Structured extraction with explicit schema"
    },
    {
      "part_number": 3,
      ...
      "task": "Generate platform-specific social posts from topic",
      "outputs": ["Twitter post", "LinkedIn post", "Instagram caption"],
      "evaluation_criteria": ["platform_appropriateness", "usability", "generation_speed", "cost_per_set"]
    },
    {
      "part_number": 4,
      "title": "Platform Comparison",
      "type": "comparative_analysis",
      "task": "Build identical sentiment analysis on two platforms",
      "test_samples": 5,
      "comparison_criteria": ["setup_time", "complexity", "output_quality", "cost_estimate", "debugging_ease", "preference"]
    },
    {
      "part_number": 5,
      "title": "Advanced Agent Workflow",
      "type": "optional_exploration",
      "platform": "Relevance AI",
      "task": "Build research agent with web search capability",
      "documentation_required": ["agent_config", "output_quality", "setup_time", "practical_utility"]
    },
    {
      "part_number": 6,
      "title": "Cost and Graduation Analysis",
      "type": "financial_analysis",
      "task": "Calculate costs at 10, 100, 1000, 10000 operations monthly",
      "platforms_to_compare": ["Zapier", "Make + API", "Custom code"],
      "required_outputs": ["graduation_threshold", "development_cost_justification"]
    }
  ],
  "deliverable": {
    "format": "document",
    "sections": ["workflow_screenshots", "prompts_used", "test_results", "platform_comparison", "cost_calculations", "graduation_recommendation"]
  },
  "success_criteria": [
    "Built 2+ working AI workflows on no-code platforms",
    "Applied I-T-O framework to prompt structure",
    "Tested with realistic scenarios",
    "Articulated platform tradeoffs",
    "Completed cost calculations at multiple scales",
    "Can advise when no-code versus code is appropriate"
  ],
  "estimated_time_minutes": 120,
  "connections": {
    "module_2": "4-layer automation model",
    "module_3": "Classification pattern, structured extraction, output format specification"
  }
}'
